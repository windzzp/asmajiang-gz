...
enum CardType
{
	...
	CARD_TYPE_QING_PENG_JIN_GOU_DIAO = 34,//清一色 碰碰胡 金钩钓
	CARD_TYPE_PENG_BIAN_QIA_DIAO = 35,//碰碰胡 + 边卡吊
	CARD_TYPE_QING_BIAN_QIA_DIAO = 36,//清一色 + 边卡吊
	CARD_TYPE_LONG_QI_BIAN_QIA_DIAO = 37,//边卡吊 + 龙七对
	CARD_TYPE_QING_PENG_BIAN_QIA_DIAO = 38,//清一色 碰碰胡 边卡吊
	CARD_TYPE_QING_LONG_QI_DUI_BIAN_QIA_DIAO = 39,// 清龙七对 + 边卡吊
	CARD_TYPE_QING_DA_KUAN_ZHANG = 40,//清一色 + 大宽张
